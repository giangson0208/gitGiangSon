...
<link rel="stylesheet" style="style/sheet" href="css/index6.css">
	...
	<div id="footer">
		...
		<div id="bg-footer">
			<div id="noidungfooter">
				...
				<div id="noidung">
					<ul>
						<li><span id="tencongty">Cửa Hàng Trà Sữa Smile Tea</span></li> <br>
						
						<li>Địa chỉ: Hoàng Mai - Hà Nội </li>
						<li>Điện thoại: 0972341193 - Hotline:  0972341193</li>
						<li>Email:  trasuasmiletea@gmail.com</li>
					</ul>
				</div><!-- End .noidung -->
				<div id="thanhngang">
