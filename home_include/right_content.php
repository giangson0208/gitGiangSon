					...
					<div class="center1">
						...
						<?php if(isset( $_SESSION['username'])){
							?>
								...
								<span id="logout"><p style="margin-right:40px"><a href="logout.php"><button>Logout</button></a></p></span>
						</div><!-- End .dangnhap-in-->
							<?php 
						}
						else{
						...
						<div id="dangnhap-in">
							<form action="dangnhap.php" method="post">
								...
								<a href="index.php?content=dangky"><button name="dangky">Đăng Ký</button></a>
...
?> <?php  echo number_format($tongtien,"0",",",".");?> VNĐ
				...
				<div id="fb-root">
					<div class="center1">
						...
						<div class="fb-like-box" data-href="https://www.facebook.com/tocotocobubbletea/" data-width="188" data-colorscheme="light" data-show-faces="true" data-header="true" data-stream="false" data-show-border="false"></div>
					</div><!-- End .center1 -->
				</div><!-- End .facebook -->