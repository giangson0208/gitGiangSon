...
if(isset($_GET['timkiem']))
{
  ...
  {
	case "1":
		$sql="select * FROM sanpham WHERE tensp like '%".$tim."%' and (gia between '0' and '15000')";	
	break;
	case "2":
		$sql="select * FROM sanpham WHERE tensp like '%".$tim."%'  and (gia between '15000' and '20000')";	
	break;
	case "3":
		$sql="select * FROM sanpham WHERE tensp like '%".$tim."%'  and (gia between '20000' and '35000')";	
	break;
	case "4":
		$sql="select * FROM sanpham WHERE tensp like '%".$tim."%'  and (gia between '35000' and '40000')";	
	break;
	case "5":
		$sql="select * FROM sanpham WHERE tensp like '%".$tim."%'  and (gia between '40000' and '55000')";	
	break;
	case "6":
		$sql="select * FROM sanpham WHERE tensp like '%".$tim."%'  and (gia >= '55000')";	
	break;
	default:
...
?>
		...
		<div class="dienthoai">
			...
			<h4>Giá : <?php echo number_format(($row['gia']*((100-$row['khuyenmai1'])/100)),0,",",".");?> VNĐ</h4>
				<div class="button">
										<ul>
											<li>
